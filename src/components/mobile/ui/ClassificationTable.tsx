            ...
            {standings.map((row, i) => (
              <motion.tr 
                ...
                className={`transition-all duration-1000 relative ${
                  row.highlighted 
                    ? "bg-primary shadow-[inset_4px_0_0_0_rgba(255,255,255,1)] z-10" 
              ...
              >
                <td className="px-6 py-4">
                  <span className={`text-xs font-black tabular-nums transition-colors duration-1000 ${
                    row.highlighted ? "text-white" : (theme === 'day' ? "text-slate-400" : "text-white/40")
                  }`}>
                    {row.pos}
                  </span>
                </td>
                ...
                <td className="px-4 py-4 text-center">
                  <span className={`text-xs font-black tabular-nums transition-colors duration-1000 ${
                    row.highlighted ? "text-white" : (theme === 'day' ? "text-slate-900" : "text-white/90")
                  }`}>
                    {row.pts}
                  </span>
                </td>
                <td className="px-6 py-4 text-center">
                  <span className={`text-xs font-bold tabular-nums transition-colors duration-1000 ${
                    row.highlighted ? "text-white/80" : (theme === 'day' ? "text-slate-300" : "text-white/20")
                  }`}>
                    {row.pj}
                  </span>
                </td>
