...
export default function Manifesto() {
  ...
  return (
        <section ref={ref} className="py-32 md:py-64 bg-[#050505] relative overflow-hidden" id="manifesto">
            ...
            <div className="absolute top-0 right-0 w-full md:w-2/3 h-full bg-primary/10 blur-[180px] rounded-full pointer-events-none opacity-40" />
            <div className="absolute -left-20 bottom-0 w-80 h-80 bg-accent/5 blur-[120px] rounded-full pointer-events-none" />
                    ...
                    <div className="flex flex-col gap-12 md:gap-20">
                        <h2 className="font-heading font-black text-[12vw] md:text-[8vw] lg:text-[10vw] leading-[0.85] uppercase text-white flex flex-col items-start select-none">
                            <motion.span 
                                ...
                                className="text-stroke hover:text-white transition-all duration-700 cursor-default"
                            >
                                Non somos só
                            </motion.span>
                            <motion.span 
                                variants={itemVariants} 
                                className="text-stroke hover:text-white transition-all duration-700 cursor-default mb-8 md:mb-12"
                            >
                                un club.
                            </motion.span>
                            ...
                            <motion.span 
                                variants={itemVariants} 
                                className="text-white drop-shadow-[0_0_30px_rgba(255,255,255,0.1)] relative"
                            >
                                Somos familia.
